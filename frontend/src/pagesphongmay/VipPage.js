...
//lấy dữ liệu bàn lên
  ...
  const outdoorTables = tables.filter(table => table.khuVucID === 4);
  return (
    <div>
    <div className="vipareapage">
    <div className="vipareapage1">
    <div className="vipareapage2">
   <span className="spantext">VIP Area</span>
    {/* Nội dung của trang Tiêu Chuẩn */}
    </div>
    <div className="vipareapage3">
      <div className="divghichuvipareacoler"></div>
      <div className="divtextghichuvipareacoler">Trống</div>
      <div className="divghichuvipareacoler1"></div>
      <div className="divtextghichuvipareacoler1">Sử Dụng</div>
      <div className="divghichuvipareacoler2"></div>
      <div className="divtextghichuvipareacoler2">Sửa Chữa</div>
      {isQuanTri && (
      <button className="btnaddbanviparea"onClick={handleShowModal}>Thêm Bàn</button>
      )}
      <AddTableModal show={showModal} handleClose={handleCloseModal} refreshTables={refreshTables} />
    </div>
    <div className="tablebanviparea">
