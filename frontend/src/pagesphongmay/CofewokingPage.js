...
//lấy dữ liệu bàn lên
  ...
  const outdoorTables = tables.filter(table => table.khuVucID === 3);
  return (
    <div>
    <div className="workingpage">
    <div className="workingpage1">
    <div className="workingpage2">
   <span className="spantext">working Area</span>
    {/* Nội dung của trang Tiêu Chuẩn */}
    </div>
    <div className="workingpage3">
      <div className="divghichuworkingcoler"></div>
      <div className="divtextghichuworkingcoler">Trống</div>
      <div className="divghichuworkingcoler1"></div>
      <div className="divtextghichuworkingcoler1">Sử Dụng</div>
      <div className="divghichuworkingcoler2"></div>
      <div className="divtextghichuworkingcoler2">Sửa Chữa</div>
      {isQuanTri && (
      <button className="btnaddbanworking" onClick={handleShowModal}>Thêm Bàn</button>
      )}
      <AddTableModal show={showModal} handleClose={handleCloseModal} refreshTables={refreshTables} />
    </div>
    <div className="tablebanworking">
